export const TEMPLATE_PRESETS = {
    pinkCases: {
        id: 'pinkCases',
        name: 'Pink Cases',
        container: 'min-h-screen bg-gradient-to-br from-pink-600 via-rose-500 to-fuchsia-600 text-white',
        card: 'bg-white/95 hover:bg-white border border-pink-200 text-gray-800 shadow-[0_10px_30px_rgba(236,72,153,0.4)] hover:shadow-[0_15px_40px_rgba(236,72,153,0.5)]',
        button: 'bg-pink-500 hover:bg-pink-600 text-black font-bold shadow-lg hover:shadow-xl transition-all' // 🔴 ROSA
    },
    neonPulse: {
        id: 'neonPulse',
        name: 'Neon Pulse',
